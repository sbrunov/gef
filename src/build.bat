...
set LOCALCP=%CLASSPATH%;..\lib\log4j-1.2.6.jar;%ANT_HOME%\lib\ant.jar;%ANT_HOME%\lib\jaxp.jar;%ANT_HOME%\lib\parser.jar;%ANT_HOME%\lib\xerces-1.2.3.jar;..\build\classes
