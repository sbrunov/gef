...
public class IntHashtable extends Dictionary implements Cloneable {
    ...
    /**
     * 
     * @return an enumeration of the elements. Use the Enumeration methods 
    ...
    /**
     * A getter that takes an Object, for compatibility with java.util.Dictionary.  
     ...
     * A shallow copy is made, the keys and elements themselves are NOT 
